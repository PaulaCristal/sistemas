...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="calendar/calendario.php">Sistema de agenda</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid px-4">
                    ...
                    <?php include "vistas/social_bar.php"; ?>
                    <!--<div class="card mb-4">
                        <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    Ejemplo de grafica de pastel
                                </div>
                                <div class="card-body">
                                    <?php
                                    include "Graficas/pastel.php";
                                    ?>
                                </div>
                                <div class="card-footer small text-muted">Datos de la tabla usuario</div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="card mb-4">
                                <div class="card-header">
                                    ...
                                    Ejemplo de grafica de Anillo
                                </div>
                                <div class="card-body">
                                    <?php
                                    include "Graficas/anillo.php";
                                    ?>
                                </div>
                                <div class="card-footer small text-muted">Datos de la tabla usuario</div>
                            </div>
